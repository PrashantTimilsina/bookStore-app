      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            <div className="dropdown text-black md:text-white">
              <div
                tabIndex={0}
                role="button"
            ...
            <a className="cursor-pointer text-2xl font-bold">bookStore</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div>
                <a
                  className="cursor-pointer rounded-md bg-black px-3 py-2 text-white duration-300 hover:bg-slate-800"
                  onClick={() =>
